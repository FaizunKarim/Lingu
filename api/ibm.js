...
export default async function handler(req, res) {
  ...
  try {
    ...
    const model = 'ibm-granite/granite-3.3-8-instruct:601ff87e6afa76bd7bdbf8292ea250d70b0ad2ddedc17c236e7fa3fe38a374a8';
    const input = { prompt, max_tokens: 512, temperature: 0.7 };
